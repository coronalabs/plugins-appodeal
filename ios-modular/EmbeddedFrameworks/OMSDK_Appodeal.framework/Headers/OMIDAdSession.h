 ...
 */
@interface OMIDAppodealAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDAppodealAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDAppodealAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDAppodealAdSessionContext *)context
