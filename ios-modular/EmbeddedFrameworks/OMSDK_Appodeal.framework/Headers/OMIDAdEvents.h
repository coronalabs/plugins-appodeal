 ...
 */
@interface OMIDAppodealAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDAppodealAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDAppodealVASTProperties *_Nonnull)vastProperties
